...
@section('content')
    ...
    >
            ...
            issues related to our official products and services. <br>
            <i><b>Đang Nâng Cấp Pulgin không liên quan lắm</b></i>
    </x-core::alert>
        ...
        <x-slot:footer>
            <div class="w-100">
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-info w-100" data-bb-toggle="accept-term-and-policy" disabled>
