...
@section('content')
    <div style="background-color: rgba(128, 128, 128, 0.8); color: red; padding: 10px; text-align: center; font-weight: bold; margin-bottom: 15px;">
        <span style="display: inline-block; animation: textScale 1.5s ease-in-out infinite;">Do not delete any plugins on this page</span>
    </div>
