<section class="tp-subscribe-area tp-subscribe-square pt-70 pb-65 theme-bg p-relative z-index-1" @if ($config['background_image']) style="background-image: url({{ RvMedia::getImageUrl($config['background_image']) }}) !important; background-repeat: no-repeat !important; background-size: cover !important;" @endif>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <!-- Added dashed line with "or" in the middle -->
        <div class="tp-divider d-flex align-items-center justify-content-center mt-30">
            <div class="tp-divider-line" style="border-top: 1px dashed white; flex-grow: 1; margin-right: 10px;"></div>
            <span style="color: white; font-size: 16px; font-weight: 500;">or</span>
            <div class="tp-divider-line" style="border-top: 1px dashed white; flex-grow: 1; margin-left: 10px;"></div>
        </div>
</section>