<section class="tp-testimonial-area grey-bg-7 pt-130 pb-135" style="background-color: #333333f5;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="tp-testimonial-slider p-relative z-index-1">
                    <div class="tp-testimonial-shape">
                        <span class="tp-testimonial-shape-gradient" style="background: linear-gradient(rgb(1 3 4), rgba(255, 255, 255, 0) 70%);"></span>
                    </div>
                    @if($title = $shortcode->title)
                        <h3 class="tp-testimonial-section-title text-center" style="color: white;">
